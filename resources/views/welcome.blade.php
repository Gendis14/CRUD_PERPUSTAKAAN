...
<body class="bg-gray-50">
    ...
    <nav class="bg-white shadow-lg">
                ...
                <div class="flex space-x-7">
                    <div>
                        <a href="#" class="flex items-center py-4 px-2">
                            <span class="font-semibold text-gray-900 text-2xl"><i class="fas fa-book-open mr-2 text-purple-600"></i> BookHub</span>
                        </a>
                    </div>
                    <div class="hidden md:flex items-center space-x-1">
                        <a href="#hero" class="py-4 px-2 text-purple-600 border-b-4 border-purple-600 font-semibold">Beranda</a>
                        <a href="#kategori" class="py-4 px-2 text-gray-500 font-semibold hover:text-purple-600 transition duration-300">Kategori</a>
                        <a href="#" class="py-4 px-2 text-gray-500 font-semibold hover:text-purple-600 transition duration-300">Populer</a>
                        <a href="#" class="py-4 px-2 text-gray-500 font-semibold hover:text-purple-600 transition duration-300">Tentang</a>
                    </div>
                </div>
                <div class="hidden md:flex items-center space-x-3">
                   <a href="#" class="py-2 px-3 font-medium text-white bg-purple-600 rounded hover:bg-purple-700 transition duration-300"><i class="fas fa-bookmark mr-1"></i> Koleksi Saya</a>
                    <a href="{{ route('login') }}" class="py-2 px-2 font-medium text-gray-500 rounded hover:bg-purple-100 hover:text-purple-600 transition duration-300"><i class="fas fa-user mr-1"></i> Login</a>
                    <a href="{{ route('register') }}" class="py-2 px-2 font-medium text-gray-500 rounded hover:bg-purple-100 hover:text-purple-600 transition duration-300"><i class="fas fa-user mr-1"></i> Register</a>
                    
                </div>
                <div class="md:hidden flex items-center">
                    <button class="outline-none mobile-menu-button">
                        <svg class="w-6 h-6 text-gray-500 hover:text-purple-600" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="hidden mobile-menu">
            <ul>
                <li><a href="#hero" class="block text-sm px-2 py-4 text-white bg-purple-600 font-semibold">Beranda</a></li>
                <li><a href="#kategori" class="block text-sm px-2 py-4 hover:bg-purple-100 transition duration-300">Kategori</a></li>
                <li><a href="#" class="block text-sm px-2 py-4 hover:bg-purple-100 transition duration-300">Populer</a></li>
                <li><a href="#" class="block text-sm px-2 py-4 hover:bg-purple-100 transition duration-300">Tentang</a></li>
            </ul>
        </div>
    </nav>
    ...
    <section id="hero" class="hero-gradient text-white py-20">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-xl md:text-2xl mb-12 max-w-2xl mx-auto">Jelajahi koleksi lebih dari 10.000 buku dari berbagai genre dan penulis terbaik</p>
            
            <!-- Search Box -->
            <div class="max-w-2xl mx-auto relative">
                <input type="text" id="searchInput" placeholder="Cari judul buku, penulis, atau kategori..." class="w-full py-4 px-6 rounded-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-600 shadow-lg">
                <button id="searchButton" class="absolute right-2 top-2 bg-purple-700 text-white py-2 px-6 rounded-full hover:bg-purple-800 transition duration-300">Cari</button>
            </div>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-6">
            <div class="flex justify-between items-center mb-12">
                ...
                <a href="#" class="text-purple-600 hover:text-purple-800 font-medium">Lihat Semua <i class="fas fa-arrow-right ml-1"></i></a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-8 rounded-xl">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-purple-200 rounded-full flex items-center justify-center text-purple-600 font-bold mr-4">AS</div>
                        <div>
                    ...
                    <p class="text-gray-600">"Koleksi bukunya lengkap sekali! Saya bisa menemukan buku langka yang tidak tersedia di toko buku biasa."</p>
                </div>
                <div class="bg-gray-50 p-8 rounded-xl">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-blue-200 rounded-full flex items-center justify-center text-blue-600 font-bold mr-4">DR</div>
                        <div>
                    ...
                    <p class="text-gray-600">"Antarmuka yang sangat user-friendly. Saya bisa dengan mudah menemukan buku yang sesuai dengan minat saya."</p>
                </div>
                <div class="bg-gray-50 p-8 rounded-xl">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-green-200 rounded-full flex items-center justify-center text-green-600 font-bold mr-4">FP</div>
                        <div>
                    ...
                    <p class="text-gray-600">"Rekomendasi bukunya sangat tepat! Sudah menemukan beberapa buku bagus yang tidak saya ketahui sebelumnya."</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-purple-700 text-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-xl mb-8 max-w-2xl mx-auto">Dapatkan akses ke koleksi buku eksklusif, rekomendasi personal, dan diskon khusus member.</p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('register') }}" class="bg-white text-purple-700 font-semibold py-3 px-8 rounded-full hover:bg-gray-100 transition duration-300">Daftar Sekarang</a>
                <a href="#" class="border-2 border-white text-white font-semibold py-3 px-8 rounded-full hover:bg-white hover:text-purple-700 transition duration-300">Pelajari Lebih Lanjut</a>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-gray-900 text-white pt-16 pb-8">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-4 flex items-center"><i class="fas fa-book-open mr-2"></i> BookHub</h3>
                    <p class="text-gray-400">Temukan dunia dalam setiap halaman. BookHub adalah platform terbaik untuk menemukan dan menikmati buku-buku berkualitas.</p>
...
<script>
    ...
    function displayBooks(booksToDisplay) {
        ...
        booksToDisplay.forEach(book => {
            ...
            bookElement.className = 'book-card bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300';
    ...
    // Ambil data buku dari database Laravel
    fetch('/api/buku')
        .then(res => res.json())
        .then(data => {
            displayBooks(data);
